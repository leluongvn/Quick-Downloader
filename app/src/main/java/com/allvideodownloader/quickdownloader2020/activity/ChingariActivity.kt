...
import com.allvideodownloader.quickdownloader2020.util.Utils.setLocale
...
//        initializeAds()
        ...
        mTvToolbarText.setText("Downloader for Chingari")
        mIvAppIcon.setImageResource(R.drawable.chingari)
...
//            Utils.showInterstitialAds(interstitialAd, googleAds)
        ...
        mLLOpenApp.setOnClickListener {
            ...
            Utils.openApp(context, "io.chingari.app")
...
//        adView = findViewById(R.id.adView) as AdView
    ...
    fun startDownloading(url: String) {
        ...
        if (url.equals("") && Utils.checkURL(url)) {
            ...
            DownloadVideoFile.Start(context!!, myurl.trim(), false)
